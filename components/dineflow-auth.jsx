...
function RightPanel({
  bgSrc,
  children,
  contentClass = "right-content flex flex-col justify-end items-start h-full",
}) {
  return (
  ...
  return (
    <div className="auth-root flex h-screen w-screen overflow-hidden">
      ...
      <div className="left-panel flex flex-col justify-center bg-white z-10 overflow-hidden flex-shrink-0 w-[46%]">
        ...
        <h1 className="form-heading font-bold text-[#111] mb-1">
          Create your account
        </h1>
        ...
        {/* Restaurant Name */}
        <div className="field">
          <label className="block font-medium text-[#333] mb-1.5">
            Restaurant Name
          </label>
          <input
            type="text"
        ...
        <div className="checkbox-row flex items-center gap-2 text-[#555]">
          ...
          <label htmlFor="terms" className="text-[#555] cursor-pointer">
            ...
            <a
              href="#"
              className="text-[#1a3d2b] font-medium no-underline hover:underline"
            >
              Terms of Service
            </a>{" "}
            and{" "}
      ...
      <RightPanel bgSrc={BURGER_BG}>
        ...
        <div className="testimonial-card glass rounded-2xl max-w-[360px] w-full text-white">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="author-name font-bold text-white">
                Chef Marco Valesquez
              </div>
              <div className="author-title text-[#4ade80] font-medium">
        ...
        <div className="flex gap-2.5">
          <div className="stat-card glass rounded-xl text-center text-white">
            ...
            <div className="stat-label text-white/70 mt-0.5">
              Platform Uptime
            </div>
          </div>
          <div className="stat-card glass rounded-xl text-center text-white">
...
export function SignInPage() {
  ...
  return (
    <div className="auth-root flex h-screen w-screen overflow-hidden">
      ...
      <div className="left-panel flex flex-col justify-center bg-white z-10 overflow-hidden flex-shrink-0 w-[46%]">
        ...
        <div className="field">
          <div className="flex justify-between items-center mb-1.5">
            ...
            <a
              href="#"
              className="forgot text-[#c0392b] font-medium no-underline hover:underline"
            >
              Forgot password?
            </a>
          </div>
        ...
        <div className="footer-links text-center text-[#aaa]">
          <a
            href="#"
            className="text-[#aaa] no-underline mx-2 hover:text-[#555] transition-colors"
          >
            Privacy Policy
          </a>
          <a
      ...
      <RightPanel
        bgSrc={CHICKEN_BG}
        contentClass="right-center relative z-10 flex items-center justify-center h-full"
      >
        <div className="bg-white/90 rounded-2xl text-center max-w-[320px] w-full px-10 py-8">
          <div className="brand-name text-3xl font-bold text-[#1a3d2b] mb-1.5">
            DINEFLOW
          </div>
          <div className="text-[#555] font-semibold uppercase tracking-[3px] text-xs">
            Manage. Serve. Grow.
          </div>
        </div>
      </RightPanel>

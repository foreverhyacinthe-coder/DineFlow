  ...
  return (
    <div className="auth-root">
      ...
      <div className="left-panel">
        <div className="logo">
          <div className="logo-icon"><CutleryIcon /></div>
        ...
        <div className="field-row">
          <div className="field">
            ...
            <div className="field-icon-wrap">
              ...
              <span className="icon" onClick={() => setShowPass(p => !p)}><EyeIcon /></span>
            </div>
          </div>
          <div className="field">
            ...
            <div className="field-icon-wrap">
              ...
              <span className="icon" onClick={() => setShowConfirm(p => !p)}><EyeIcon /></span>
            </div>
          </div>
        </div>
        ...
        <p className="alt-link">
          Already have an account? <button className="link-btn" style={{ color: "#1a3d2b", fontWeight: 600 }} onClick={onSwitch}>Sign In</button>
        </p>
      </div>
        ...
        <div className="right-content">
          <div className="testimonial-card">
            ...
            <p className="testimonial-text">
              "DineFlow has completely transformed how we orchestrate service at Le Jardin. The precision and real-time insights allow my team to focus entirely on the culinary experience."
            </p>
            <div className="testimonial-author">
              <div className="author-avatar-placeholder">MV</div>
              <div>
                <div className="author-name">Chef Marco Valesquez</div>
                <div className="author-title">3 Michelin Stars, Executive Director</div>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="auth-root">
      ...
      <div className="left-panel">
        ...
        <p className="form-subheading">Enter your credentials to access the kitchen admin dashboard.</p>

        <div className="field">
          <label>Email Address</label>
          <div className="field-icon-wrap">
            <input type="email" placeholder="chef@dineflow.com" />
            <span className="icon"><AtIcon /></span>
          </div>
        </div>
        ...
        <p className="alt-link" style={{ marginBottom: 24 }}>
          Don't have an account? <button className="link-btn" style={{ color: "#1a3d2b", fontWeight: 600 }} onClick={onSwitch}>Signup</button>
        </p>
